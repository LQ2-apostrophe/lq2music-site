	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<xsl:variable name="tableMinWidth" select="'600px'"/><xsl:variable name="colorMain" select="'#333'"/><xsl:variable name="colorAccent" select="'#dc0000'"/><xsl:variable name="relativeFontColor" select="'#ffffff'"/><title>XML Sitemap &#124; LQ2&#039;</title><style style="text/css">	body {
		font-size: 14px;
